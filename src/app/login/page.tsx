                        ...
                        <form className='flex flex-col lg:min-h-[594px]'>
                            ...
                            <div className='flex items-center justify-between mt-7 pr-10'>
                                <label className='flex text-base text-gray cursor-pointer group transition-all transform duration-300 ease-in-out'>
                                    <input
                                        type="checkbox"
                                        className='w-4 h-4 text-green-600 bg-gray-100 rounded border-cool-gray focus:ring-green-500' 
                                    />
                                    <span className='ml-2 select-none group-hover:text-green transition-all duration-300 ease-in-out'>Remember me</span>
                                </label>
                                <a href="#" className='text-sm text-green hover:text-green font-lato'>
                                    Lost your password?
                                </a>
                            </div>
                            <div className='flex justify-between'>
                                <button className="mt-10 w-[553px] h-[52px] bg-green text-white font-semibold rounded-full hover:bg-green-600 transition-all duration-300 ease-in-out">
                                    LOG IN
                                </button>
                            </div>
                        </form>
