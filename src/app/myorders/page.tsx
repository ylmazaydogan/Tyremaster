    ...
    <div className="min-h-screen">
      <div className="md:border-b border-light-silver-2 relative h-fit">
        <div className="flex flex-col py-6 lg:py-0 lg:pt-8 lg:pb-11 responsive relative z-10">
          <span className="text-sm lg:text-base uppercase text-gray">
            all your account details
          </span>
          <h2 className="text-2xl lg:text-4xl font-semibold mt-2 uppercase text-black">
            my account
          </h2>
          <p className="text-sm lg:text-base uppercase text-gray">
            access your account to manaage personel information, track orders,
            and more.
          </p>
        </div>
      </div>
          ...
          <div className="w-3/4">
            <div className="bg-white border border-light-silver rounded-st p-10 ">
              <div className="flex items-center">
                <h2 className="text-4xl text-black font-bold uppercase">
                  My Orders
                </h2>
              ...
              <div className="bg-white p-10 rounded-st border border-light-silver-2">
                ...
                <div className="space-y-4">
                  {[1, 2].map((item, index, array) => (
                    <div
                      key={item}
                      className="bg-white p-5 rounded-st border-b border-cool-gray -space-y-6"
                    >
                      <div className="flex items-start justify-between text-black mb-2">
                        <div className="w-1/3"></div>
                        <div className="w-1/6 text-center font-semibold text-sm">
                          Unit price
                        </div>
                        <div className="w-1/6 text-center font-semibold text-sm">
                          Quantity
