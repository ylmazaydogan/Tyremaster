    ...
    return (
        <div className="hidden xl:flex flex-col p-12 w-1/6 bg-white border border-light-silver-2 rounded-st h-fit">
            ...
            <div className="flex flex-col space-y-5">
                <Link href="/my-information" className="flex items-center font-semibold text-black hover:text-green text-xs-custom">
