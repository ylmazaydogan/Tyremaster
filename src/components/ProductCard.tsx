      ...
      <div className="flex items-center justify-between">
        <div className="flex flex-col items-start w-1/3">
          <div className="flex items-center space-x-4">
            ...
            />
            <div>
              <h2 className="font-semibold text-black text-base ">Hankook</h2>
              <p className="text-sm text-black ">Maxxis Mecotra 3</p>
              <p className="text-sm text-medium-gray ">Description: 215/55R18 99V</p>
              <p className="text-sm text-medium-gray ">Season: Summer</p>
            </div>
          </div>
          <button className="mt-2 flex items-center text-black bg-light-gray text-xs border-light-silver px-4 py-2 ml-9 rounded font-bold ">
            X REMOVE
          </button>
        </div>
