export default function HowWeWork() {
    return (
        <div className=" border-b border-light-silver-2">
            <div className="w-[92%] xl:w-[83%] mx-auto">
                <div className="flex items-center flex-col gap-2.5  mx-auto">
                    <p className="text-base text-medium-gray uppercase mt-10 ">SEE OUR COLLECTION</p>
                    <p className="text-black text-4xl font-semibold uppercase text-center mt-2.5 ">HOW WE WORK</p>
                    <p className="text-center text-gray text-base mt-2 ">There are many variations of passages of lorem ipsum available.</p>
                </div>

                <div className="flex flex-col mb-12 xl:flex-row xl:divide-x divide-[#818181]/20 mt-12 justify-center xl:space-x-12">
