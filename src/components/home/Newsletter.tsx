const Newsletter = () => {
    return (
        <div className="flex flex-col gap-8  items-center relative">
            ...
            <div className="flex shadow-lg p-2 w-[800px] h-[72px] mx-auto bg-white mt-10 relative ml-40">
                <div className="flex w-full relative z-10">
                    <input
                        ...
                        className="w-[800px] h-[56px] px-6 py-4 text-gray bg-transparent outline-none rounded-none"
                    />
                </div>
                <button className="ml-3.5 mt-3.5">
            ...
            <div className="absolute right-0 bottom-0 flex space-x-4 mb-10 mr-6 ">
                <div className="relative w-[483px] h-[291px]">
                    {/* Mobile image */}
                    <img
                        src="/images/newsletter-iphone.png"
                        alt="Mobile Excel view"
                        className="absolute left-0 bottom-0 w-[120px] h-auto z-10"
                    />
                    {/* Desktop image */}
                    <img
