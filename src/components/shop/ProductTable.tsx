...
//           newFilters[filterType][attrId].Value = newFilters[filterType][
//             attrId
...
//             <TableHead className="text-sm font-bold text-black text-left w-32">
//               BRAND
//             </TableHead>
//             <TableHead className="text-sm font-bold text-black text-left">
//               NAME
//             </TableHead>
//             <TableHead className="text-sm font-bold text-black text-left w-24">
//               SIZE
//             </TableHead>
//             <TableHead className="text-sm font-bold text-black text-left w-24">
//               STOCK
...
//                 )}
//               </TableCell>
//               <TableCell className="py-4 text-black font-bold text-sm w-32">
//                 {product.Brand}
//               </TableCell>
//               <TableCell className="py-4 text-black text-sm ">
//                 {product.Name}
//               </TableCell>
//               <TableCell className="py-4 text-black text-sm w-24 whitespace-nowrap">
//                 {product.Size}
//               </TableCell>
//               <TableCell className="py-4 text-black w-24 whitespace-nowrap">
//                 {product.Stock} pcs
//               </TableCell>
//               <TableCell className="py-4 text-black font-bold w-32 whitespace-nowrap">
